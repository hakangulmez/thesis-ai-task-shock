...
While ChatGPT constituted the catalytic event — the moment general-purpose language model capabilities became accessible at scale to non-technical users and enterprise procurement teams — the competitive pressure documented in this thesis reflects the broader emergence of capable LLMs, including subsequent systems such as GPT-4, Claude, Gemini, and open-source alternatives, all of which expanded and reinforced the substitution and commodification dynamics initiated in November 2022.

I identify three mechanisms through which the AI shock may affect software firms. The *substitution* mechanism predicts that high-replicability firms lose revenue as customers replace specialized software with general-purpose AI tools or AI-native competitors. The *commodification* mechanism predicts that high-replicability firms experience margin compression even without revenue loss, as the existence of credible AI alternatives erodes pricing power and forces defensive investment. The *reinforcement* mechanism predicts a null result for low-replicability firms — those whose products perform deeply integrated, infrastructure-dependent tasks that LLMs cannot replicate face low exposure to AI-driven substitution and should therefore show no differential post-shock revenue or margin decline.
...
Viewing B2B software firms as *task intermediaries* — entities that insert themselves between enterprise customers and the cognitive tasks those customers need performed — clarifies the mechanism through which generative AI creates competitive pressure. The value proposition of a task intermediary rests on two conditions: first, the tasks it performs are sufficiently difficult for customers to perform internally; second, no lower-cost alternative performs them adequately. Generative AI puts pressure on both conditions simultaneously. When both are undermined, the intermediary faces a structural threat analogous to that faced by travel agents, stockbrokers, and classified advertising platforms when digital technologies made direct exchange accessible: the risk of disintermediation. The substitution and commodification mechanisms documented in this thesis are consistent with this structural process — they represent the financial consequences of AI eroding the two conditions that justified the task intermediary role in the first place. This interpretation is held with appropriate caution: the data identifies differential revenue and margin outcomes, not the internalization of tasks per se. The disintermediation framing is a theoretical lens for understanding why those outcomes take the specific form they do.
...
The identifying assumption requires that, absent the generative AI shock, firms with different replicability levels would have followed parallel trends in the outcome variables. I test this assumption using the event study specification:
...
[Figure 5: Revenue growth trajectory indexed to 100 at 2022 Q3 per firm]
[Figure 6: Median quarterly revenue pre/post by replicability quartile]
...
A further clarification concerns the interpretation of all three mechanisms: the results reflect differences in *exposure* to AI-driven substitution across firms, not differences in AI adoption behavior. Firm-level AI adoption is not observed in the financial panel data used in this thesis. The findings are therefore interpreted as heterogeneous financial consequences of differential substitution exposure — high-replicability firms face greater exposure because their product tasks are more readily replaceable by LLMs, not because they failed to adopt AI. Similarly, the null result for low-replicability firms reflects low substitution exposure, not superior adoption. This distinction is important for causal interpretation: the treatment variable captures pre-determined product characteristics, not post-shock strategic responses.

Taken together, the substitution and commodification findings are consistent with a deeper structural process: the *disintermediation* of B2B software firms as task intermediaries. In classical disintermediation — the elimination of travel agents by online booking platforms, stockbrokers by direct trading, or newspaper classified advertising by online marketplaces — incumbents lose their intermediary role when technology enabling direct exchange becomes accessible at low cost. Generative AI puts pressure on an analogous dynamic in the software industry: by making it plausible for enterprise customers to perform cognitive tasks directly — or to access AI-native alternatives that perform them at lower cost — it puts pressure on the justification for the task intermediation layer that B2B SaaS firms represent. The commodification mechanism, in which pricing power compresses before revenue declines, is consistent with what one would expect in disintermediation dynamics: customers become aware of direct alternatives and begin extracting value at renewal before they are able to fully act on them. Substitution, where it occurs, represents a further stage of that process. This interpretation is not directly identified in the data — the empirical results are differential revenue growth and margin compression, not observed task internalization — but it is consistent with the pattern of findings and provides a structural framing that connects the two mechanisms to a single underlying dynamic.
...
This thesis investigated whether B2B software firms experienced heterogeneous financial outcomes after the generative AI shock, depending on how replicable their core product tasks are by large language models. Using a difference-in-differences design with a novel SBERT-based task replicability index applied to 143 publicly listed software firms, I identified two empirically distinguishable mechanisms. The substitution channel — captured by absolute task replicability — is associated with a statistically and economically significant reduction in post-shock revenue growth (β = −1.051, bootstrap p = 0.018), equivalent to $30.3 million lower quarterly revenue per standard deviation of replicability. The commodification channel — captured by relative task replicability versus infrastructure-oriented tasks — is associated with gross margin compression without corresponding revenue loss (β = −0.114, bootstrap p = 0.047), consistent with pricing power erosion as the market recognized that AI alternatives existed.
...
A three-period decomposition of the post-shock effects reveals that these consequences are not a one-time adjustment but an intensifying process: the revenue displacement effect grew 57 percent larger in the advanced AI era relative to the early AI era, and gross margin commodification — absent when the generative AI shock first hit — emerged only once AI capabilities matured sufficiently to become credible enterprise outside options in 2024. As the automation frontier continues to advance, the set of software products vulnerable to displacement and commodification will expand further.
